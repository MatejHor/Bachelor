...
% SETTINGS - NAMES
\newcommand{\myTitle}[0] {Spracovanie volumetrických medicínskych dát metódami umelej inteligencie pre lekársku diagnózu}
\newcommand{\myName}[0] {Matej Horniak}
...
\newcommand{\myDegreeCourse}[0] {9.2.5 Informatika}
